...
class _AppointmentDetailsPageState extends State<AppointmentDetailsPage>
  ...
  Future<void> _fetchAnimalDetails() async {
    ...
    final url = Uri.parse(
        "http://192.168.107.58:5000/get_specific_animal?animal_id=$animalId");
  ...
  Future<void> _fetchAppointmentHistory() async {
    final animalId = widget.appointment['animal_id'];
    final url = Uri.parse(
        "http://192.168.107.58:5000/get_animal_appointment_history?animal_id=$animalId");
  ...
  Future<void> _updateAppointment() async {
    ...
    final url =
        Uri.parse("http://192.168.107.58:5000/update_appointment_status");
